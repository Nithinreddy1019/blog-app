    ...
    <div className={`rounded-xl overflow-hidden shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] ${className}`}>
      ...
      <div className='p-5'>
        ...
        <p className='text-dark-light mt-3 text-sm md:text-lg'>
            Majority of people will work in jobs that are related to tech.
        </p>
        ...
        <div className='flex justify-between flex-nowrap items-center mt-6'>
            <div className='flex items-center gap-x-2 md:gap-x-2.5'>
                ...
                <div className='flex flex-col'>
                    <h4 className='font-bold italic text-dark-soft text-sm md:text-base'>Violetts Magnus</h4>
            ...
            <span className='font-bold text-dark-light italic text-sm md:text-base'>03 Feb</span>
        </div>
      </div>
    </div>
  )
